...
<html lang="en">
  <head>
    ...
    <title>Edit Profile · Marvia</title>
  ...
  <header class="blog-header py-3">
    ...
    <nav class="nav d-flex justify-content-between">
      <a class="p-2 text-muted" href="marvia.php">Visit Profile</a>
