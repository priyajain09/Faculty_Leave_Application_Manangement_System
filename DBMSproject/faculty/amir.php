...
session_start();
 ...
 $document = $collection->findOne(['user_id'=>'amir_a']);
?>
<!doctype html>
<html lang="en">
  <head>
  ...
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 d-flex justify-content-end align-items-center">
        ...
        <a class="btn btn-sm btn-outline-secondary" href="../destroy.php"><?php if(isset($_SESSION["user_id"])){if(strcmp($_SESSION["user_id"],"amir_a")==0){echo "LogOut";}}?></a>
      </div>
    </div>
  </header>
    ...
    <nav class="nav d-flex justify-content-between">
      <a class="p-2 text-muted" href="edit_amir.php"><?php if(isset($_SESSION["user_id"])){if(strcmp($_SESSION["user_id"],"amir_a")==0){echo "Edit Profile";}}?></a>
      <!-- <a class="p-2 text-muted" href="#">U.S.</a> -->
      <?php if(isset($_SESSION["user_id"])){if(strcmp($_SESSION["user_id"],"amir_a")==0){echo' <div class="dropdown">
