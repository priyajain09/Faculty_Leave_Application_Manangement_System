...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  ...
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 d-flex justify-content-end align-items-center">
        ...
        <a class="btn btn-sm btn-outline-secondary" href="../destroy.php"><?php if(isset($_SESSION["user_id"])){if(strcmp($_SESSION["user_id"],"anurag_agarwal")==0){echo "LogOut";}}?></a>
      </div>
    </div>
  </header>
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between">
      <a class="p-2 text-muted" href="edit_anurag.php"><?php if(isset($_SESSION["user_id"])){if(strcmp($_SESSION["user_id"],"anurag_agarwal")==0){echo "Edit Profile";}}?></a>
      <!-- <a class="p-2 text-muted" href="#">U.S.</a> -->
      <?php if(isset($_SESSION["user_id"])){if(strcmp($_SESSION["user_id"],"anurag_agarwal")==0){echo' <div class="dropdown">
