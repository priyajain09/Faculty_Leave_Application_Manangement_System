<?php 
 ...
 $document = $collection->findOne(['user_id'=>'punit_arora']);
?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <title>Edit Profile · Punit</title>
  ...
  <header class="blog-header py-3">
    ...
    <nav class="nav d-flex justify-content-between">
      <a class="p-2 text-muted" href="punit.php">Visit Profile</a>
